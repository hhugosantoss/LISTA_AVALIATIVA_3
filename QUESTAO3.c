...
int main() {
    ...
    }else if ((strcmp(diaSemana, "TERCA-FEIRA") == 0 && (ultimoDigitoPlaca == '2' || ultimoDigitoPlaca == '3'))){
        printf("%s nao pode circular %s\n", placa, diaSemana2);
    }else if ((strcmp(diaSemana, "QUARTA-FEIRA") == 0 && (ultimoDigitoPlaca == '4' || ultimoDigitoPlaca == '5'))){
        printf("%s nao pode circular %s\n", placa, diaSemana2);
    }else if ((strcmp(diaSemana, "QUINTA-FEIRA") == 0 && (ultimoDigitoPlaca == '6' || ultimoDigitoPlaca == '7'))){
        printf("%s nao pode circular %s\n", placa, diaSemana2);
    }else if ((strcmp(diaSemana, "SEXTA-FEIRA") == 0 && (ultimoDigitoPlaca == '8' || ultimoDigitoPlaca == '9'))){
        printf("%s nao pode circular %s\n", placa, diaSemana2);
